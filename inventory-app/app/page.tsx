export default function Home() {
  return (
    <main style={{ fontFamily: "Arial, sans-serif", background: "#0b0f1a", color: "#e6e8ee" }}>
      {/* Top bar */}
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "18px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 34, height: 34, borderRadius: 10, background: "linear-gradient(135deg,#6ee7ff,#a78bfa)" }} />
          <div>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <a href="/upload" style={{ ...btnStyle, background: "linear-gradient(135deg,#6ee7ff,#a78bfa)", color: "#0b0f1a" }}>
            Try Demo
          </a>
        </div>
      </div>
      ...
      {/* Hero */}
      <section style={{ padding: "58px 20px 30px" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 26 }}>
          <div>
            ...
            <h1 style={{ margin: "14px 0 10px", fontSize: 44, lineHeight: 1.12, letterSpacing: -0.6 }}>
              Stop guessing.<br />Know what to reorder, hold, or liquidate.
            </h1>
            ...
            <div style={{ marginTop: 18, display: "flex", gap: 12, flexWrap: "wrap" }}>
              ...
              <a href="#how" style={{ ...btnStyle, background: "transparent", border: "1px solid #2a3350", color: "#e6e8ee" }}>
                See how it works
              </a>
            </div>
          ...
          <div style={{ ...cardStyle, padding: 16, alignSelf: "start" }}>
            ...
            <div style={{ marginTop: 12, padding: 12, borderRadius: 14, border: "1px solid #202946", background: "rgba(20,27,48,0.55)" }}>
              ...
              <ul style={{ margin: 0, paddingLeft: 18, color: "#c8cee0", lineHeight: 1.7, fontSize: 14 }}>
                <li>Reorder <b>SKU-102</b> (lead time 7d)</li>
                <li>Discount <b>SKU-088</b> (overstock 120d)</li>
                <li>Freeze buying <b>SKU-055</b> (low velocity)</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      {/* How it works */}
      <section id="how" style={{ padding: "44px 20px" }}>
      ...
      {/* Pricing */}
      <section id="pricing" style={{ padding: "44px 20px" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto" }}>
      ...
      {/* FAQ */}
      <section id="faq" style={{ padding: "44px 20px 70px" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            ...
            <Faq q="What CSV format is required?" a="We’ll support a simple template: SKU, on_hand, sales_30d, lead_time_days (we’ll build the template)." />
...
function Step({ n, title, desc }: { n: string; title: string; desc: string }) {
  return (
    <div style={{ ...cardStyle, padding: 16 }}>
      <div style={{ width: 34, height: 34, borderRadius: 12, background: "rgba(110,231,255,0.12)", display: "grid", placeItems: "center", fontWeight: 900 }}>
        {n}
      </div>
